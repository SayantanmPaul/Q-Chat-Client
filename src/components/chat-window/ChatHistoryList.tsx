...
import { IconDots, IconEdit, IconPin, IconShare, IconTrash } from '@tabler/icons-react';
...
const ChatHistoryItem = () => {
  ...
  return (
    <div
      className={cn(
        `group flex w-full items-center justify-between gap-2 rounded-md py-1 pr-2 pl-4 transition-colors hover:dark:bg-[#582f2f] ${isMenuOpen ? 'dark:bg-[#161616]' : 'bg-transparent'}`,
      )}
    >
      <Button
        variant="ghost"
