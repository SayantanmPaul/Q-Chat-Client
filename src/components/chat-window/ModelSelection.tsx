    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      {modelData && modelData.length > 0 && (
        <DropdownMenuContent
          align="start"
          sideOffset={12}
          className="flex h-52 w-auto max-w-sm flex-col gap-2 overflow-clip overflow-y-scroll rounded-3xl border border-zinc-900/80 bg-[#404040]/40 p-3 text-gray-200 backdrop-blur-sm"
        >
